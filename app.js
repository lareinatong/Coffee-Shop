...
var LareinaCoffeeReviewApp = angular.module('LareinaCoffeeReviewApp', ['ngRoute',
'ui.bootstrap']);

LareinaCoffeeReviewApp.config(['$routeProvider',
...
LareinaCoffeeReviewApp.controller('CoffeeListCtrl', function($scope, $rootScope) {
$scope.coffees =
       [
       {'id': 1,
